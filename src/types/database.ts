...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      pairing_codes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pairing_codes_consent_device_id_fkey"
            columns: ["consent_device_id"]
            isOneToOne: false
            referencedRelation: "devices"
            referencedColumns: ["id"]
          },
      ...
      profiles: {
        Row: {
          ...
          verified_role:
            | Database["public"]["Enums"]["profile_verified_role"]
            | null
        }
        Insert: {
          avatar_url?: string | null
    ...
    Functions: {
      _claim_pairing_row: {
        Args: {
          p_riga: Database["public"]["Tables"]["pairing_codes"]["Row"]
          p_uid: string
        }
        Returns: Json
      }
      ...
      claim_pairing_by_consent: {
        Args: { p_device_id: string; p_install_id: string }
        Returns: Json
      }
