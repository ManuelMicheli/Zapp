...
export function FloatingNav() {
  ...
  // solo sulla scheda titolo la barra azioni prende il posto della nav
  // (la pagina stagione non ha barra azioni e deve conservare la nav)
  if (/^\/title\/(movie|tv)\/[^/]+$/.test(pathname)) return null;
  return (
    <>
