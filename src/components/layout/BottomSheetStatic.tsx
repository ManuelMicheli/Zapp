...
export function BottomSheetStatic({ children, gap = 20 }: Props) {
  return (
    <div
      className="relative mt-auto flex w-full flex-col rounded-t-[32px] border-t border-white/[0.08] bg-sheet px-6 pb-9 pt-3.5 shadow-[0_-20px_60px_rgba(0,0,0,0.7)] lg:mt-0 lg:max-w-[440px] lg:rounded-[32px] lg:border-0 lg:p-10 lg:shadow-none"
      style={{ gap }}
    >
