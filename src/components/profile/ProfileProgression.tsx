...
export function ProfileProgression({ counts, profileId, isOwn, className = "" }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 rounded-[22px] border border-border bg-surface p-4 md:p-5">
        ...
        <details className="group mt-4 border-t border-border pt-1">
          ...
          <div className="flex flex-col gap-5 pb-1 pt-3">
            ...
            <div className="text-xs leading-relaxed text-muted">
              ...
              <p className="mt-2">
                5 punti per ogni film o serie distinti segnati come visti, 2 per ogni
                titolo votato e 10 per ogni recensione non oscurata di almeno 80
                caratteri, esclusi gli spazi iniziali e finali. Import e rimozioni
                aggiornano i conteggi. Modificare un voto o una recensione non aggiunge
                punti: ogni titolo conta una volta per ciascuna categoria.
              </p>
              <p className="mt-2">
                Limiti: 2.500 punti dalle visioni, 2.000 dai voti e 5.000 dalle
                recensioni. Il livello racconta la tua partecipazione su Zapp.
              </p>
            </div>
          </div>
        </details>
