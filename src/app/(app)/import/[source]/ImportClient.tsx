...
export function ImportClient({ source }: { source: SourceMeta }) {
  ...
  return (
    <div className="space-y-4 lg:space-y-7">
      <div className="flex items-center gap-3.5 pb-1.5 lg:gap-5">
        <SourceMark slug={source.slug} size={56} className="rounded-2xl" />
        <p className="text-pretty text-[15px] leading-[1.45] text-white/80 lg:max-w-[760px] lg:text-[17px]">
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start lg:gap-6">
        <div className="space-y-3.5 rounded-[20px] border border-border bg-surface p-[18px] lg:p-7">
          <p className="text-[15px] font-semibold lg:text-[18px]">
            Come scaricare il tuo storico
          </p>
          ...
          {source.esempio && (
            <a
              href={source.esempio}
              download
              className="inline-block text-xs font-medium text-accent-pale underline underline-offset-2 focus-visible:rounded-sm focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent-pale"
            >
        ...
        <div className="space-y-4">
          <div
            ...
            className={`flex flex-col items-center gap-2.5 rounded-[22px] border-[1.5px] border-dashed px-5 py-7 lg:min-h-[240px] lg:justify-center lg:gap-3.5 ${
              dragging
                ? "border-accent bg-accent/[0.12]"
                : "border-accent/50 bg-accent/[0.06]"
            }`}
          >
            <div className="flex size-[52px] items-center justify-center rounded-[14px] bg-accent/[0.18] lg:size-[60px]">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
