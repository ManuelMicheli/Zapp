...
export default function NetflixImportPage() {
  return (
    <main className="relative px-5 pb-[220px] lg:px-10 lg:pb-36">
      <div
        aria-hidden="true"
      ...
      />
      <header className="relative flex items-center gap-3.5 pt-[calc(env(safe-area-inset-top,0px)+40px)] lg:pt-[104px]">
        <BackButton inline />
