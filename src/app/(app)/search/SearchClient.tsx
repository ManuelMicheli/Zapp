...
export function SearchClient({ discover }: { discover?: React.ReactNode }) {
  ...
  return (
    <div>
      {/* offset = altezza della TopBar: safe-area + pt 40 + titolo 34 + pb 16; da lg copre anche la fascia della TopNav fissa (72px) e parte sotto di essa */}
      <div className="sticky top-[calc(env(safe-area-inset-top,0px)+90px)] z-10 -mx-5 bg-bg px-5 pb-4 lg:-mx-10 lg:top-0 lg:px-10 lg:pt-[84px]">
