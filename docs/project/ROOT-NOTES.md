...
Per un audit puntuale usare `git show 5394dae:CLAUDE.md`. La root non e' ancora
stata sostituita dal candidato, gli altri worktree restano preservati e
`origin/main` non contiene ancora questo consolidamento.
