...
Anche `POST /api/tv/v1/play` (l'app TV, `docs/architecture/tv.md`) scrive una riga di
`device_commands` gia' consegnata: e' la stessa dichiarazione, con le stesse regole.
